...
{ 
    public class BorrowAutoCategoryEquipmentViewModelValidator : AbstractValidator<BorrowAutoCategoryEquipmentViewModel>
    {
        public BorrowAutoCategoryEquipmentViewModelValidator()
        {
