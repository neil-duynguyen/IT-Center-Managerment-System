...
namespace KidProEdu.Application.Validations.CategoryEquipments
{
    ...
    public class ReturnCategoryEquipmentViewModelValidator : AbstractValidator<ReturnCategoryEquipmentViewModel>
    {
        public ReturnCategoryEquipmentViewModelValidator()
        {
