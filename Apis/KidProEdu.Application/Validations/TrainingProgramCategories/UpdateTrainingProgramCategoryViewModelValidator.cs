...
namespace KidProEdu.Application.Validations.TrainingProgramCategories
{
    ...
    public class UpdateTrainingProgramCategoryViewModelValidator : AbstractValidator<UpdateTrainingProgramCategoryViewModel>
    {
        public UpdateTrainingProgramCategoryViewModelValidator()
        {
